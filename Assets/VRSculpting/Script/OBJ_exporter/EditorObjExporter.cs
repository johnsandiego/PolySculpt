...
public class EditorObjExporter : MonoBehaviour
{
	...
	public GameObject ExportLocation;
	public Text ExportText;

	public AudioSource ExportSound;
	...
	public void ExportOneMesh()
	{
		...
		exportedObjects++;
		ExportText.text = targetFolder;
		StartCoroutine (ExportLocationPopUp ());
//		if (exportedObjects > 0)
//		{
...
//			Debug.Log("Objects not exported " + " Make sure at least some of your selected objects have mesh filters!" + "");
	...
	IEnumerator ExportLocationPopUp(){
		ExportLocation.SetActive (true);
		yield return new WaitForSeconds (5f);
		ExportLocation.SetActive (false);
	}
	#endif
